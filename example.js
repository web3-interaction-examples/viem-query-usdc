...
// https://etherscan.io/address/0x0483b0dfc6c78062b9e999a82ffb795925381415#code 
...
// this only supports viem@1 version
...
// 5. Define an asynchronous function to fetch NFT information
async function getNFTInfo(tokenId) {
  try {
    ...
    const ownerAddress = await nftContract.read.ownerOf([BigInt(tokenId)])
...
// 6. Call the function, passing the tokenId to query
const tokenId = 1
